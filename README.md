...
![AURA NETWORKS Preview](https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80)

---

## ✨ Features

- **Cinematic Motion UI**: Built with Orbitron and Cinzel typography, neon/gold color grading, and glassmorphism styling.
- **Floating Parallax Elements**: Dynamic scroll-based floating badges and indicators.
- **3D Interactive Card Movement**: Hardware-accelerated 3D tilt effects on hover.
- **Audio Controls**: Unmuted launch experience with a floating Mute/Unmute speaker toggle widget.
